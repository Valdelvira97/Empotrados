...
CAPathPlanner::CAPathPlanner(const char * const roomname,
		TEDROOMComponentID id, 
		TEDROOMUInt32 roomNumMaxMens,
		TEDROOMPriority roomtaskPrio,
		TEDROOMStackSizeType roomStack,
		CEDROOMMemory *pActorMemory ) : 

		CEDROOMComponent(roomname,id,EDROOMprioMINIMUM+1,roomNumMaxMens,
...
bool CAPathPlanner::EDROOMIsComponentFinished()
{
