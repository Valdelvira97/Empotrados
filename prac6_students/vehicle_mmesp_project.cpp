...
rtems_task Init (uint32_t arg){
	...
	Vehicle	comp1("MainActor_id1", 1, 16, EDROOMprioVeryHigh, 1024, systemDeployment.GetComp1Memory());
	CAPathPlanner	comp2("PathPlanner_id2", 2, 13, EDROOMprioVeryLow, 2048, systemDeployment.GetComp2Memory());
	CAPathTracker	comp3("PathTracker_id3", 3, 13, EDROOMprioNormal, 2048, systemDeployment.GetComp3Memory());
	CCAvoidObstacles	comp4("AvoidObstacles_id4", 4, 13, EDROOMprioNormal, 1024, systemDeployment.GetComp4Memory());
