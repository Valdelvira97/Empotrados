...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp1->AvoidObstaclesSysCtrl, mp_comp1, "C1.AvoidObstaclesSysCtrl");
	m_localCommSAP.RegisterInterface(2, mp_comp1->Timer, mp_comp1, "C1.Timer");
	m_localCommSAP.RegisterInterface(3, mp_comp1->PathPlannerCtrl, mp_comp1, "C1.PathPlannerCtrl");
	m_localCommSAP.RegisterInterface(4, mp_comp1->PathTrackerCtrl, mp_comp1, "C1.PathTrackerCtrl");
 
	// Register Interface for Component 2
	m_localCommSAP.RegisterInterface(1, mp_comp2->Timer, mp_comp2, "C2.Timer");
	m_localCommSAP.RegisterInterface(2, mp_comp2->TrackPath, mp_comp2, "C2.TrackPath");
	m_localCommSAP.RegisterInterface(3, mp_comp2->PathPlannerCtrl, mp_comp2, "C2.PathPlannerCtrl");
 
	// Register Interface for Component 3
	m_localCommSAP.RegisterInterface(1, mp_comp3->Timer, mp_comp3, "C3.Timer");
	m_localCommSAP.RegisterInterface(2, mp_comp3->TrackPath, mp_comp3, "C3.TrackPath");
	m_localCommSAP.RegisterInterface(3, mp_comp3->PathTrackerCtrl, mp_comp3, "C3.PathTrackerCtrl");
 
	// Register Interface for Component 4
	m_localCommSAP.RegisterInterface(1, mp_comp4->AvoidObstaclesSysCtrl, mp_comp4, "C4.AvoidObstaclesSysCtrl");
	m_localCommSAP.RegisterInterface(2, mp_comp4->Timer, mp_comp4, "C4.Timer");
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp1->AvoidObstaclesSysCtrl, mp_comp4->AvoidObstaclesSysCtrl, connections[0], 
